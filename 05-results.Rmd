...
```{r ch05-3-1}
# df_data_missing %>%
#   filter(`Indicator Code` %in% c("EG.ELC.RNEW.ZS","EG.ELC.NUCL.ZS"))%>%
#   mutate(indicator_name = case_when(
#     `Indicator Code` == "EG.ELC.RNEW.ZS" ~ "Other Source",
#     `Indicator Code` == "EG.ELC.NUCL.ZS" ~ "Nuclear Source",
#   ))%>%
#   select(-`Indicator Name`)%>%
#   pivot_longer(cols = "1971":"2018",names_to = "year")%>%
#   left_join(df_selected_country,by = "Country Name")%>%
