...
The importation of data is straight forward using `read_csv` function is R. We import `WDIData.csv`, `WDISeries.csv` and `WDICountry.csv` as dataframe `df_data`, `df_series` and `df_countries` respectively. Since the country name and series name are repeated to cover every combination, we treat them as factors to ease the operation.
